...
In hiring, a [2024 Resume Builder survey](https://www.resumebuilder.com/1-in-2-companies-have-replaced-workers-with-ai-in-2024/) found 60% of managers use AI to evaluate direct reports, with 94% reporting AI influenced hiring and firing decisions. A [Cornell University study](https://arxiv.org/abs/2302.10893) found that workplace AI monitoring produced worse performance outcomes and higher rates of employee complaints. The monitoring was implemented by the employer. The employees were the subjects.

In tenant screening, a [2023 National Consumer Law Center report](https://www.nclc.org/resources/automated-background-checks-unfair-opaque-and-discriminatory/) documented AI-driven background check tools producing outcomes with discriminatory patterns, trained on historical data that encoded existing discrimination. The landlord was the client. The applicant submitted the form.
...
The [MIT Technology Review's 2025 AI accountability report](https://www.technologyreview.com/2025/02/18/1111817/ai-accountability-gap/) described what it called the "exposure gap": the distance between where AI systems are operating and where any governance structure can see them. That gap is widest precisely where the stakes are highest, in healthcare, housing, credit, and employment, where the AI was deployed by an institution with the resources to configure it carefully and the person affected by the outcome has no visibility into what configuration they encountered.

[The AI Now Institute's 2025 annual report](https://ainowinstitute.org/research/state-of-ai-2025) documented that 50 to 80% of employees in surveyed organizations use AI tools not approved or monitored by their employers. The shadow AI population creates a second layer of unaccountable configuration, below the institutional level, where individuals are making operator-level decisions about AI systems without the resources or expertise to do it well, and without anyone who can be held responsible when it goes wrong.
...
[McKinsey's 2025 State of AI report](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) projected that enterprise AI deployment would triple between 2024 and 2027. Each deployment is a new configuration. Each configuration shapes what the AI can and cannot do for the users inside it. The [Stanford HAI 2026 AI Index](https://aiindex.stanford.edu/report/) found that the number of distinct AI models in commercial deployment grew by 340% between 2022 and 2025.
...
The [EU AI Act](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32024R1689), which took effect in 2024, takes the second position as a legislative matter, requiring disclosure in high-risk deployments and establishing accountability requirements for operators in healthcare, employment, and credit. The [NIST AI Risk Management Framework](https://www.nist.gov/system/files/documents/2023/01/26/AI%20RMF%201.0.pdf) takes a more procedural position, emphasizing documentation and transparency at the organizational level without mandating user-facing disclosure. The [FTC's 2024 AI report](https://www.ftc.gov/reports/ai-report) found that existing consumer protection law covers most current harms but enforcement capacity has not scaled with deployment rates.
